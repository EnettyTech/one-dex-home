...
export const Policy = (props) => {
  return (
    <div className="w-full mt-36 px-10 pb-10">
      <h1 className="text-center font-bold text-4xl mb-6">Privacy Policy</h1>
      <p>
        ONEDEX TECHNOLOGY COMPANY LIMITED built the OneDex app as a Free app.
        This SERVICE is provided by ONEDEX TECHNOLOGY COMPANY LIMITED at no cost
      ...
      <p className="mb-2">
        ...
        Terms and Conditions, which are accessible at OneDex unless otherwise
