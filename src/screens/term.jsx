...
export const Term = (props) => {
  return (
    <div className="w-full mt-36 px-10 pb-10">
      ...
      <p>
        ...
        other intellectual property rights related to it, still belong to ONEDEX
        TECHNOLOGY COMPANY LIMITED.
      </p>
      <p>
        ONEDEX TECHNOLOGY COMPANY LIMITED is committed to ensuring that the app
      ...
      <p>
        The OneDex app stores and processes personal data that you have provided
        ...
        features and it could mean that the OneDex app won't work properly or at
        all.
      </p>
      <div>
        <p>
      ...
      <p>
        You should be aware that there are certain things that ONEDEX TECHNOLOGY
        COMPANY LIMITED will not take responsibility for. Certain functions of
        ...
        ONEDEX TECHNOLOGY COMPANY LIMITED cannot take responsibility for the app
      ...
      <p>
        Along the same lines, ONEDEX TECHNOLOGY COMPANY LIMITED cannot always
        ...
        can't turn it on to avail the Service, ONEDEX TECHNOLOGY COMPANY LIMITED
        cannot accept responsibility.
      </p>
      <p>
        With respect to ONEDEX TECHNOLOGY COMPANY LIMITED's responsibility for
        ...
        to us so that we can make it available to you. ONEDEX TECHNOLOGY COMPANY
        LIMITED accepts no liability for any loss, direct or indirect, you
      ...
      <p className="mb-2">
        ...
        updates if you want to keep using the app. ONEDEX TECHNOLOGY COMPANY
        LIMITED does not promise that it will always update the app so that it
        is relevant to you and/or works with the Android &amp; iOS version that
        you have installed on your device. However, you promise to always accept
      ...
      <p>
        ...
        do not hesitate to contact us at onedex.finance@gmail.com.
      </p>
    </div>
  );
};
